...
def test_pipeline_stage_values():
    ...
    expected = {"intake", "context_review", "source_review", "analysis",
                "assembly_plan_review", "report_review",
                "outline_review", "slide_building", "content_generation",
                "qa", "deck_review", "finalized", "error"}
